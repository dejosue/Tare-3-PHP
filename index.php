...
<body class="d-flex flex-column min-vh-100">
  <main class="flex-grow-1">
    ...
    <center><button type="button" class="btn btn-outline-success" id="openModalBtn">
        Agregar Estudiante
      </button></center>
    </section>
    <!-- TABLA -->
    <section class="my-1 mx-3">
      <table class="table table-striped table-hover">
        ...
        <tbody>
          ...
          // Consulta SQL para obtener la información de los estudiantes
          $sql = "SELECT * FROM colegio.estudiantes e 
            INNER JOIN colegio.tipos_sangre ts 
